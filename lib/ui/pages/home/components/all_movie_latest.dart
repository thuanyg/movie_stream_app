...
class AllLatestMovies extends StatefulWidget {
  ...
  @override
  State<AllLatestMovies> createState() => _AllLatestMoviesState();
}
    ...
    return SizedBox(
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: <Widget>[
            Padding(
              padding: EdgeInsets.symmetric(horizontal: size.width / 3.5, vertical: 2),
                        ...
                        child: Column(
                          children: [
                            GridView.builder(
                              ...
                              itemCount: provider.listLatestMovie.length,
                                      ...
                                      Opacity(
                                        ...
                                        child: Center(
                                          child: ImageHelper.loadNetworkImage(
                                            provider.listLatestMovie[index]
                                                .posterUrl!,
